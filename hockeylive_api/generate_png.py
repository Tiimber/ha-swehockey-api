...
_TC: dict[str, tuple] = {
    ...
    "vaxjo_lakers_hc":("#FF6600","#052f5d",None), "vaxjo_lakers":("#FF6600","#052f5d",None), "vaxjo":("#FF6600","#052f5d",None),
    ...
    "vasteras_ik":("#fdd200","#2a2a2a",None), "vik_vasteras_hk":("#fdd200","#2a2a2a",None), "vasteras":("#fdd200","#2a2a2a",None),
    ...
    "visby_roma_hk":("#2166c7","#ffffff","#ffe36e"), "visby_roma":("#2166c7","#ffffff","#ffe36e"), "visby":("#2166c7","#ffffff","#ffe36e"), "vimmerby":("#fddd01","#2a2a2a","#ffffff"),
...
_ABBR: dict[str, str] = {
    ...
    "vaxjo_lakers_hc":"VLH","vaxjo_lakers":"VLH","vaxjo":"VLH",
    ...
    "nybro_vikings_if":"NVIF","nybro":"NVIF",
    "troja_ljungby":"TRO","if_troja_ljungby":"TRO","troja":"TRO",
    "sodertalje_sk":"SSK","sodertalje":"SSK",
    "vasteras_ik":"VIK","vik_vasteras_hk":"VIK","vasteras":"VIK",
    "kalmar_hc":"KHC","kalmar":"KHC",
    "ostersunds_ik":"ÖIK","ostersund":"ÖIK",
    "vimmerby_hc":"VH","vimmerby_hockey":"VH","vimmerby":"VH",
    "visby_roma_hk":"VIS","visby_roma":"VIS","visby":"VIS",
