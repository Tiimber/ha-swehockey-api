...
_TEAM_COLORS = {
    # SHL
    "brynas_if": ("#1e1d1b", "#ffffff", "#fecc03"),
    "brynas": ("#1e1d1b", "#ffffff", "#fecc03"),
    ...
    "lulea_hf": ("#000000", "#d10c12", "#fdcd01"),
    "lulea": ("#000000", "#d10c12", "#fdcd01"),
    "malmo_redhawks": ("#ffffff", "#bb0b2e", "#000000"),
    "malmo": ("#ffffff", "#bb0b2e", "#000000"),
    "modo_hockey": ("#CC0000", "#FFFFFF", None),
    "modo": ("#CC0000", "#FFFFFF", None),
    "rogle_bk": ("#ffffff", "#067b35", "#a4272a"),
    "rogle": ("#ffffff", "#067b35", "#a4272a"),
    "skelleftea_aik": ("#fbba14", "#1d1d1d", None),
    "skelleftea": ("#fbba14", "#1d1d1d", None),
    "saik": ("#fbba14", "#1d1d1d", None),
